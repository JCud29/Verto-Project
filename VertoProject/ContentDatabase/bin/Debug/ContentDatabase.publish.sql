...
GO
PRINT N'Creating Table [dbo].[SectionOne]...';
...
GO
PRINT N'Creating Table [dbo].[SectionThree]...';


GO
CREATE TABLE [dbo].[SectionThree] (
    [Id]         INT           NOT NULL,
    [cardNumber] INT           NOT NULL,
...
GO
PRINT N'Creating Table [dbo].[SectionTwo]...';


GO
CREATE TABLE [dbo].[SectionTwo] (
    [Id]         INT           NOT NULL,
    [cardNumber] INT           NOT NULL,
    [cardLabel]  NVARCHAR (50) NULL,
    [cardOffer]  NVARCHAR (50) NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '83f50649-a536-4019-b4bf-80e128074ab3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('83f50649-a536-4019-b4bf-80e128074ab3')
